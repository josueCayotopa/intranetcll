<!-- resources/views/archivos/edit.blade.php -->
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold mb-6 text-gray-800">Editar Archivo</h1>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <form action="{{ route('archivos.update', $archivo->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nombre" id="nombre" value="{{ $archivo->nombre }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Nombre del archivo">
                </div>
                <div class="mb-4">
                    <p class="block text-gray-700 text-sm font-bold mb-2">Archivo actual:</p>
                    <p class="text-gray-600">{{ $archivo->nombre }} ({{ round($archivo->tamano / 1024, 2) }} KB)</p>
                </div>
                <div class="mb-6">
                    <label for="archivo_pdf" class="block text-gray-700 text-sm font-bold mb-2">Reemplazar archivo PDF (opcional):</label>
