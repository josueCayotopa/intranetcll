    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Imagen de Perfil -->
                <div>
                    <label for="foto" class="block text-sm font-medium text-gray-700">Imagen de Perfil</label>
                    <div class="mt-1 flex items-center">
                        ...
                        <input type="file" name="foto" id="foto" accept="image/*" class="ml-5 bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
                    </div>
                </div>
            </div>
